...
(function() {
  ...
  module.exports = Configuration = (function() {
    ...
    console.log("cfg:26" + Configuration.userConfigurationPath);
    ...
    Configuration.optionNames = ["bin", "httpPort", "timeout", "workers", "domains", "extDomains", "hostRoot", "logRoot", "rvmPath"];
    ...
    Configuration.prototype.initialize = function(env) {
      var _base, _base1, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      this.env = env;
      this.bin = (_ref = env.POW_BIN) != null ? _ref : path.join(__dirname, "../bin/pow");
      this.httpPort = (_ref1 = env.POW_HTTP_PORT) != null ? _ref1 : 80;
      this.timeout = (_ref2 = env.POW_TIMEOUT) != null ? _ref2 : 15 * 60;
      this.workers = (_ref3 = env.POW_WORKERS) != null ? _ref3 : 2;
      this.domains = (_ref4 = (_ref5 = env.POW_DOMAINS) != null ? _ref5 : env.POW_DOMAIN) != null ? _ref4 : "dev";
      this.extDomains = (_ref6 = env.POW_EXT_DOMAINS) != null ? _ref6 : [];
      ...
      this.hostRoot = (_ref9 = env.POW_HOST_ROOT) != null ? _ref9 : path.join(this.supportRoot, "Hosts");
      this.logRoot = (_ref10 = env.POW_LOG_ROOT) != null ? _ref10 : libraryPath("Logs", "Pow");
      this.rvmPath = (_ref11 = env.POW_RVM_PATH) != null ? _ref11 : path.join(process.env.HOME, ".rvm/scripts/rvm");
