...
(function() {
  var Installer, InstallerFile, async, chown, daemonSource, fs, mkdirp, path, util,
  ...
  module.exports = Installer = (function() {
    ...
    Installer.getSystemInstaller = function(configuration) {
      ...
      files = [new InstallerFile("/Library/LaunchAgents/cx.pow.powd.plist", daemonSource(this.configuration), true)];
